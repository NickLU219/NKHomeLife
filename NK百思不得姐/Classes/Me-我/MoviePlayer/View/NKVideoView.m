...
- (void)layoutSubviews {
    ...
    if (self.shouldShowHideParentNavigationBar) {
        if ([[self superviewNavigationController] isNavigationBarHidden] && (UIDeviceOrientationIsPortrait([UIDevice currentDevice].orientation))) {
