...
@interface NKVideoPlayerViewController () <videoViewDelegate>
@property (nonatomic, strong) NKVideoView *player;
@end

@implementation NKVideoPlayerViewController
...
- (void)setupPlayer:(NSURL*)url {
    ...
    // Create video player
    NKVideoView *aPlayer;
    aPlayer = [[NKVideoView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height) contentURL:url];
