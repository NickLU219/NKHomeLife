//
//  NKCategoryCollectionViewCell.m
//  NKVideoPlayer
//
...
@interface NKCategoryCollectionViewCell()
/**
 *  背景大图
 */
...
@implementation NKCategoryCollectionViewCell
/**
 *  创建cell(从缓存池中取)
 */
+ (instancetype)cellWithCollectionView:(UICollectionView *)collectionView ItemAtIndexPath:(NSIndexPath *)indexPath
{
    NKCategoryCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellID forIndexPath:indexPath];

    //    cell.backgroundColor = [UIColor redColor];

    return (NKCategoryCollectionViewCell *)cell;
}
