...
@interface NKVideoTableViewCell ()
...
@end
@implementation NKVideoTableViewCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    NKVideoTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[NKVideoTableViewCell alloc]initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
