...
@interface NKEssenceViewController () <UIScrollViewDelegate>
/** 标签栏底部的红色指示器 */
...
- (void)setupChildVces {
    ...
    video.title = @"视频";
    video.type = NKTopicTypeVideo;
    [self addChildViewController:video];

    NKTopicTableViewController *voice = [[NKTopicTableViewController alloc] init];
    voice.title = @"声音";
...
- (void)tagClick {
    NKRecommendTagsViewController *tags = [[NKRecommendTagsViewController alloc] init];
